...
def set_weight_decay(model, skip_list=(), skip_keywords=()):
    ...
    return [
        {'params': has_decay_add, 'lr': 8e-5},
        {'params': has_decay_backbone, 'lr_scale': 0.1,'lr': 2e-5},
        {'params': no_decay_add, 'weight_decay': 0., 'lr': 8e-5},
        {'params': no_decay_backbone, 'weight_decay': 0., 'lr_scale': 0.1,'lr': 2e-5}
    ]
