...
def build_loader(config):
	...
	elif config.data.dataset == 'algae':
		root = os.path.join(config.data.data_root, 'algae')
		train_set = ALGAE(root, True, train_transform)
		test_set = ALGAE(root, False, test_transform)
		num_classes = 32
